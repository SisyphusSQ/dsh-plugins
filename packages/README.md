...
| [`dsh-session-tools`](dsh-session-tools/README.md) | 实验中，未发布 | 会话列表、快照读取、创建、重命名、Fork、跨会话 relay、Web `@会话` | `0.1.0-rc.6` |
| [`dsh-thinking-collapse`](dsh-thinking-collapse/README.md) | 实验中，已完成隔离 profile 验收 | 聊天视图的 Codex 式思考与工具调用折叠 | `0.1.0-rc.6` |
| [`dsh-git-worktree`](dsh-git-worktree/README.md) | 实验中，未发布 | Git worktree host 命令、模型工具、CLI 与 Web 弹层 | `0.1.0-rc.6` |
