...
| 包 | 能力 |
| --- | --- |
| [dsh-thinking-collapse](dsh-thinking-collapse/README.zh.md) | Web 聊天里整轮一条耗时行；内层思考保持 DSH 默认 Think 行 |
| [dsh-composer-skill-mention](dsh-composer-skill-mention/README.zh.md) | Web 输入框的 `$` / `￥` Skill 提及 |
