...
| --- | --- |
| [dsh-thinking-collapse](dsh-thinking-collapse/README.md) | Codex-style collapse: one elapsed row per turn; inner thoughts keep DSH Think rows |
| [dsh-composer-skill-mention](dsh-composer-skill-mention/README.md) | `$` / `￥` Skill mentions in the Web composer |
